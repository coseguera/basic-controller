...
import (
	...
	"github.com/coseguera/basic-controller/pkg/generated/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type BasiccontrollerV1alpha1Interface interface {
...
// NewForConfig creates a new BasiccontrollerV1alpha1Client for the given config.
...
// NewForConfigAndClient creates a new BasiccontrollerV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*BasiccontrollerV1alpha1Client, error) {
	...
	return &BasiccontrollerV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new BasiccontrollerV1alpha1Client for the given config and
...
func New(c rest.Interface) *BasiccontrollerV1alpha1Client {
	return &BasiccontrollerV1alpha1Client{c}
}
