...
import (
	...
	v1alpha1 "github.com/coseguera/basic-controller/pkg/apis/basiccontroller/v1alpha1"
	scheme "github.com/coseguera/basic-controller/pkg/generated/clientset/versioned/scheme"
...
type DemoInterface interface {
	...
	UpdateStatus(ctx context.Context, demo *v1alpha1.Demo, opts v1.UpdateOptions) (*v1alpha1.Demo, error)
...
func newDemos(c *BasiccontrollerV1alpha1Client, namespace string) *demos {
	return &demos{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *demos) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Demo, err error) {
...
func (c *demos) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DemoList, err error) {
...
func (c *demos) Create(ctx context.Context, demo *v1alpha1.Demo, opts v1.CreateOptions) (result *v1alpha1.Demo, err error) {
	result = &v1alpha1.Demo{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("demos").
...
func (c *demos) Update(ctx context.Context, demo *v1alpha1.Demo, opts v1.UpdateOptions) (result *v1alpha1.Demo, err error) {
	result = &v1alpha1.Demo{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("demos").
...
func (c *demos) UpdateStatus(ctx context.Context, demo *v1alpha1.Demo, opts v1.UpdateOptions) (result *v1alpha1.Demo, err error) {
	result = &v1alpha1.Demo{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("demos").
...
func (c *demos) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Demo, err error) {
	result = &v1alpha1.Demo{}
