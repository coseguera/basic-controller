...
import (
	...
	basiccontrollerv1alpha1 "github.com/coseguera/basic-controller/pkg/apis/basiccontroller/v1alpha1"
	versioned "github.com/coseguera/basic-controller/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/coseguera/basic-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/coseguera/basic-controller/pkg/generated/listers/basiccontroller/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.BasiccontrollerV1alpha1().Demos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BasiccontrollerV1alpha1().Demos(namespace).Watch(context.TODO(), options)
			},
		},
		&basiccontrollerv1alpha1.Demo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *demoInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&basiccontrollerv1alpha1.Demo{}, f.defaultInformer)
}
